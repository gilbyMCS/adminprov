...
$queryInsert = ("INSERT INTO videos(nombreVideo,urlVideo,nombreVideo2,urlVideo2,fecha)VALUES ('" . $nombreVideo . "',
	'" . $url_final_video . "','" . $nombreVideo2 . "','" . $url_final_video2 . "','" . $fecha . "')");
$result = mysqli_query($conexion, $queryInsert);
$ultimoId=mysqli_insert_id($conexion);

if ($result==1) {
	$query="UPDATE info_negocio SET id_video='$ultimoId'";
