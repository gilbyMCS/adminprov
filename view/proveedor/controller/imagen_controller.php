<?php 
//imagen1
$name_negocio=$_POST['name_negocio'];
...
$img3=addslashes(file_get_contents($_FILES['img1']['tmp_name']));
//imagen4
$name4=$_POST['name4'];
$descri4=$_POST['descri4'];
$img4=addslashes(file_get_contents($_FILES['img1']['tmp_name']));
//imagen5
$name5=$_POST['name5'];
$descri5=$_POST['descri5'];
$img5=addslashes(file_get_contents($_FILES['img1']['tmp_name']));
