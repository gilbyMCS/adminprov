                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo $negocio ?>">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label>Descripcion del negocio:</label>
                                                    <input type="text" class="form-control" id="descripcion" name="descripcion" value="<?php echo  $descrip ?>">
                                                </div>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="cel" name="cel" value="<?php echo $cel ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="face" name="face" value="<?php echo $face ?>">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                ...
                                <div class="card-body">
                                    <form id="img_update">
                                        ...
                                        <div class="container">
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <input type="text" class="form-control" name="descri1" value="<?php echo  $ds1 ?>">
                                                </div>
                                            </div>
                                            <br>
                                            <div class="row">
                                                <div class="col-6">
                                                    <label>Nombre de la imagen:</label>
                                                    <input type="text" class="form-control" name="name2" value="<?php echo  $name2 ?>">
                                                </div>
                                                <div class="col-6">
                                                    <label>Descripcion de la imagen:</label>
                                                    <input type="text" class="form-control" name="descri2" value="<?php echo  $ds2 ?>">
                                                </div>
                                            </div>
                                            <br>
                                            <div class="row">
                                                <div class="col-6">
                                                    <label>Nombre de la imagen:</label>
                                                    <input type="text" class="form-control" name="name3" value="<?php echo  $name3 ?>">
                                                </div>
                                                <div class="col-6">
                                                    <label>Descripcion de la imagen:</label>
                                                    <input type="text" class="form-control" name="descri3" value="<?php echo  $ds3 ?>">
                                                </div>
                                            </div>
                                            <br>
                                            <div class="row">
                                                <div class="col-6">
                                                    <label>Nombre de la imagen:</label>
                                                    <input type="text" class="form-control" name="name4" value="<?php echo  $name4 ?>">
                                                </div>
                                                <div class="col-6">
                                                    <label>Descripcion de la imagen:</label>
                                                    <input type="text" class="form-control" name="descri4" value="<?php echo  $ds4 ?>">
                                                </div>
                                            </div>
                                            <br>
                                            <div class="row">
                                                <div class="col-6">
                                                    <label>Nombre de la imagen:</label>
                                                    <input type="text" class="form-control" name="name5" value="<?php echo  $name5 ?>">
                                                </div>
                                                <div class="col-6">
                                                    <label>Descripcion de la imagen:</label>
                                                    <input type="text" class="form-control" name="descri5" value="<?php echo  $ds5 ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <br>
                                        ...
                                        <div class="text-center">
                                            <button type="button" class="btn btn-primary btn-block" id="btnactualizar">Actualizar :)</button>
                                        </div>
                                    </form>
                                </div>
