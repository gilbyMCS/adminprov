                    ...
                    <div class="col-lg-12 my-3">
                        <div class="card rounded-0">
                            <div class="container mt-5 pd-5">
                                ...
                                <form action="../controller/actualizarVideoYoutube.php" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nombreVideo" class="form-control"value="<?php echo$row['nombreVideo']  ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="urlVideo">Pegar URL del Video <em>(Desde Youtube)</em></label>
                                        <input type="text" name="urlVideo" class="form-control" value="<?php echo$row['urlVideo']  ?>">
                                    </div>
